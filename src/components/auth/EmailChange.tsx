...
const EmailChange = (props: any): JSX.Element => {

    const {auth: {user: {email, previousPassword}}, setAuth, actualizarInfo} = useAuth();
            ...
            <form onSubmit={handleSubmit} className='bg-white p-4 mx-auto w-3/4 md:w-2/5 rounded-xl'>
                <div>
                    ...
                    <input 
                        ...
                        onChange={ev => {setPersonalInfo({...personalInfo, email: ev.target.value})}}
                    />
